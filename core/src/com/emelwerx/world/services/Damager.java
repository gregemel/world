...
public class Damager {
    public static void playerCreatureCollide(PlayerComponent playerComponent, CreatureComponent creatureComponent) {
    ...
    public static void playerShotCreature(CreatureComponent creatureComponent) {
